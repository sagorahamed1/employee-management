...
class  NotificationsController extends GetxController{
  ...
  getGetNotifications()async{
    ...
    if(response.statusCode == 200){
      totalPage = jsonDecode(response.body["data"]['pagination']['totalPages'].toString()) ?? 0;
      totalResult = jsonDecode(response.body["data"]['pagination']['totalNotifications'].toString()) ?? 0;
